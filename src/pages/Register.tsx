import { IonPage, IonButton, IonInput, IonLabel, useIonAlert, } from '@ionic/react';
        ...
        <IonPage>
            <div style={{ padding: '20px', height: '100%', width: '100%', display: 'flex', flexDirection: 'column', backgroundColor: 'white', color: 'black' }}>
                ...
                <div style={{ paddingTop: '40px', }}>
                    ...
                    <IonInput onIonInput={(e: any) => setEmail(e.target.value)} clearOnEdit={true} placeholder="Enter email" type='email'></IonInput>
                </div>
                ...
                <div style={{ paddingTop: '20px', }}>
                    ...
                    <IonInput onIonInput={(e: any) => setConfirmPassword(e.target.value)} clearOnEdit={true} placeholder="Enter password"></IonInput>
                </div>
                <div style={{ paddingTop: '50px', }}>
                    <IonButton onClick={registration} size="large" expand='block'>Sign Up</IonButton>
                </div>
